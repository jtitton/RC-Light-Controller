# Habilidades, Requisitos e Solução de Problemas — Sistema de Luzes RC v7.0
...
1. **Soldagem Eletrônica Básica:** Solde os resistores e as barras de pinos macho na placa perfurada de 5x7cm. Aqueça a junção por 2 segundos antes de aplicar o estanho para obter uma solda brilhante e resistente à vibração.
...
| **Conformal Coating / Clear Polish**| Protect shield board and sensor traces against moisture. | **Recommended** |
...
4. **MPU-6050 Mounting:** Secure the sensor to the chassis using foam double-sided tape (3M VHB) to absorb high-frequency motor vibration. The 3D vector algorithm handles orientation automatically.
